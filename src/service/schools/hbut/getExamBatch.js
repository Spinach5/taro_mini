...
import { extractExamBatch } from "../../../utils/business/hbut/examBatchHelper";
import { AutoRetry } from "./autoRetry";
import runtimeLogger from "../../../utils/common/runtimeLogger";

const _cachedExamBatch = withCache(
	"v1_exam_batch",
	60 * 60 * 1000,
	async (semester) => {
...
export async function getExamBatch(semester) {
	...
	return _cachedExamBatch(semester);
}

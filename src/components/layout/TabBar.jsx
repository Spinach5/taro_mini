...
const TAB_LIST = [
	...
	{ pagePath: "/pages/course/index", text: "课程", iconClass: "calendar" },
	{ pagePath: "/pages/user/index", text: "我的", iconClass: "user" },
];
...
export default function TabBar({ currentPath }) {
	...
	const selectedIndex = TAB_LIST.findIndex(
			...
			{TAB_LIST.map((item, index) => (
				...
				>
					<AtIcon
						...
						color={selectedIndex === index ? "#47a5fd" : "#000000"} // color 直接传字符串
					/>
					{/* <View
						className={`${item.iconClass} tab-bar-icon`}
						style={{
							color:
								selectedIndex === index ? "#47a5fd" : "#000000",
						}}
					/> */}
					<Text
